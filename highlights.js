...
(function () {
  ...
  var TOOLS = {
    ...
    "writers-conference": {
      ...
      desc: "A planning conversation with Marker before you start drafting to clarify your thoughts and structure.",
      dot: "bg-markerYellow",
    ...
    collaboration: {
      name: "Collaboration",
      desc: "A suite of features built to help writers work together, keeping ideas - not just comments - at the centre.",
      dot: "bg-markerYellow",
